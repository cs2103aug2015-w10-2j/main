...
```
###### Time4WorkUI\FullValueCell.java
``` java
...
```
###### Time4WorkUI\TaskController.java
``` java
...
```
###### Time4WorkUI\UserInterface.java
``` java
...
```
###### Time4WorkUI\view\Time4Work.css
``` css
.background {
...
```
###### Time4WorkUI\view\Time4Work.fxml
``` fxml
      ...
      <BorderPane prefHeight="620.0" prefWidth="600.0" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="0.0" AnchorPane.rightAnchor="0.0" AnchorPane.topAnchor="0.0">
         ...
         <center>
            <GridPane prefHeight="450.0" prefWidth="600.0">
               <children>
                  <Label id="taskTable" fx:id="taskTitle" stylesheets="@Title.css" text="TIME4WORK" textAlignment="CENTER">
                     <GridPane.margin>
                        <Insets bottom="5.0" left="10.0" right="10.0" top="5.0" />
                     </GridPane.margin>
                  </Label>
                  <TableView fx:id="taskTable" stylesheets="@Time4Work.css" GridPane.rowIndex="1">
                     <columnResizePolicy>
