...
public class Logic {
    ...
    private FeedbackMessage executeDelete(ArrayList<Integer> userInputIndexes) throws IOException {
    ...
    private FeedbackMessage executeMarkTaskAsDone(ArrayList<Integer> userInputIndexes) throws IOException {
